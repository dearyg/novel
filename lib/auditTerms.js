// Technical terms for Audit Mode — mapped to Life of an SDE's universe.
...
const AUDIT_TERMS = [
  ...
  },
  {
    ...
    tip: "[META_SIMULATION] Julian Meridian's public initiative — a neural matrix offering infinite digital utopias. Dramatic irony: the characters are already inside a system of this exact architecture.",
  },
  {
    term: "Somatic Bleed",
  ...
  {
    term: "Auberval Astralis",
    tip: "[OBJECT_TAG] UID: Julian_Meridian. Platinum, 40mm, ~98g. Access from any other UID = Pointer Error. Biometric proof of the bleed.",
  },
  {
    term: "The Singleton",
