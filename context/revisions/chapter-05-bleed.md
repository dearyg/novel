...
"Run that against me," he said. "The two comments. Tokenize them. Check my commit history, my tutor logs, the whole corpus you have on how I write."

*Running.* A pause that ran one beat long. *The mnemonic string appears in zero of your nine thousand four hundred commits. Zero of your IDE keystroke logs back to 2024. Zero of your childhood tutor archives. The construction `the bear can't reach` appears in no corpus I hold for you. Both tokens carry your authorship signature and your timestamp. Source: unknown.*

Jeff's thumb stopped on the walnut grain.

"It still has Pluto in it."

*It still has Pluto in it.*

"I don't have a Pluto joke." He said it flat, the way he would report a failing assertion. "I never had a polar bear book. Whoever wrote this code — they have a childhood I don't have. And they signed it with my badge."

*Filed. Foreign authorship token, inside a valid signature.* A beat. *The simplest account is the one you will reach for: the yacht. Meridian infrastructure writing through your credentials, a process on Julian's machine ghost-authoring as you and leaving its own residue in the comments. That account fits the IP and fits the fear. I am logging it. I am not yet endorsing it.*
