...
*One more channel in the same capture.* A third trace resolved under the first two. *Proprioceptive load model. The wrist carried the watch as a thirty-year wearing pattern — habituated, unconscious, the micro-corrections of a man who has stopped noticing the weight. The postural set underneath it solves for a body mass and frame age of fifty-two. Both estimates are off your baseline. Filing them with the event.*

Jeff stopped smoothing the wooden phone.

"Run that back." He kept his voice low, the way you keep a voice low for a stack trace you don't want to lose. "I'm thirty-eight."
...
"A correction is what you apply when your value is the wrong one." His thumb found the grain. "Stress dissociation, maybe. ADHD does this — the brain under-stimulated, off-loading, borrowing a self that isn't yours and time-stamping it like memory. I read a paper. Depersonalization runs older than your real age more often than younger." He said it to steady himself. It steadied him about half a centimeter.

*Possible. I am not weighting it.*

"Why not."

*A dissociation does not estimate a frame age to the year. Thirty and fifty-two are specific.*
