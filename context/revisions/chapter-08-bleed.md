...
Then it does not stop. The hallway floor opens into a kitchen he has never cooked in: a wide island, a knife coming down through chicken in even strokes, a small girl — eight, he knows she is eight the way he knows his own boot size — narrating from a stool a story about a dragon who codes, the dragon types with his claws, the dragon ships on Friday. Face-down on the counter, a telephone in a case of wood, dark grain, doing nothing. He reaches for the field medic kneeling over him to say a name and the name that arrives is *Maya.* He bites it back before his mouth can finish it. *That is not my kitchen,* he tells himself, in the only voice he has, the one that describes the shoulder in the third person. *I have never owned a wooden telephone. I do not have a daughter. Same program. Different colors.* The medic is a stranger. The medic is not Maya. He does not have time to wonder why his mouth knew otherwise.
...
*One further item from the same query.* The pane forks; a single stream isolates, highlighted. *One of the eleven thousand four hundred sixteen is an outlier. For four hundred milliseconds at the onset its wearable returned non-physiological tokens into the pain-report field — text, not vitals. Slicing chicken. A dragon who codes. A wooden phone, face-down. The tokens resolve against one household in my own corpus: yours. The other eleven thousand four hundred fifteen returned a shoulder. This one returned your kitchen. Origin of the substitution: unknown. I am flagging the stream, not explaining it.*

Jeff goes still on the concrete. "Whose wearable."

*Source field reads a Meridian Aerospace combat-sim harness. Not a consumer device. The biographical tokens are yours and the hardware is not. I cannot reconcile the two. Filed at severity one.*

*Eleven thousand four hundred sixteen matched reports,* Aion repeats, restoring the count to the pane, *the anchor unchanged. The outlier is logged beside it, not inside it.*
...
"The outlier," he says. "The one with my kitchen in the pain field. Same source network."

*Same harness vendor. The outlier's source coordinates are the casualty's coordinates, within instrument error. The stream that returned your daughter's dragon story is the conscript's stream. I am not asserting a cause. I am asserting that one record in a war zone briefly contained your household, and that it cannot have read it from anywhere I can find.*

"He gave my kitchen back to a soldier I've never met," Jeff says, slower. Then, the line he came to say:
...
*Sub-record appended. Biographical token bleed, household match, holder not you. Cross-referenced. Not explained.*
