...
*One more item from the thirteen, flagged and not pursued.* The cursor held. *Two of the carriers resolve to a single identity on the harmonic signature. Same fingerprint, two anonymous strangers, neither aware of the other. I attached their public vital records to disambiguate. The records will not disambiguate. One file gives a date of birth of twelve March 1989. The other, attached to the same resolved identity, gives twelve March 1991. Same day, same month, two years apart.*

"Pull a third record. Tiebreak it."

*There is no third record. There is the contradiction.* A pane held two source-tagged lines, the dates stacked, neither yielding. *Their vital records disagree on a fact that cannot disagree for one person. I am logging it at severity one and not pursuing it. I am flagging the contradiction, not the conclusion.*

Jeff wrote both years on the whiteboard, side by side, and did not erase either. `'89 | '91`.

"Two birth certificates resolving to one signature." He kept his voice flat. "That's not a person. That's two endpoints behind one identity. A pool. Somebody linked them and the registry layers never reconciled."

*That is a hypothesis. It is consistent with the data and so are three others. I am not selecting among them.*

"A hidden network would look exactly like this," Jeff said. "Brain-linked, back-end-merged, one harmonic address fronting two bodies. Meridian has the telemetry to build that."

*Filed at severity one. I hold the discrepancy. I decline the inference.*
